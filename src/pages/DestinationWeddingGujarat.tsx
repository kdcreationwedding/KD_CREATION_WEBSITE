...
import { ArrowRight, Globe, Compass, Phone } from 'lucide-react';
...
export const DestinationWeddingGujarat: React.FC<PageProps> = ({ onBackToHome, onOpenBooking }) => {
  return (
    <div className="min-h-screen bg-[#33060D] text-[#F5F2EB] pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12">
        ...
        <div className="flex items-center gap-2 text-xs font-mono text-gold mb-8">
          ...
          <span>/</span>
          <span className="text-white">Destination Wedding Photographer Gujarat</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <span className="px-4 py-1.5 rounded-full bg-gold/15 border border-gold/40 text-gold text-xs font-mono font-bold uppercase tracking-widest inline-block mb-4">
              Royal & Heritage Destination Photography
            </span>
            <h1 className="text-4xl sm:text-6xl font-serif-luxury font-bold leading-tight mb-6">
              Destination Wedding Photographer in <span className="text-gold-gradient italic font-normal">Gujarat & Udaipur</span>
            </h1>
            <p className="text-base sm:text-lg text-[#F5F2EB]/80 leading-relaxed mb-8">
              KD Creation specializes in multi-day destination wedding coverage across Udaipur, Jaipur, Anand, Diu, Kutch, Goa, and international destinations. Full travel crew management, 4K cinema trailers, and fine-art albums.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://wa.me/919033032922?text=Hi%20KD%20Creation,%20I%20am%20planning%20a%20destination%20wedding."
                target="_blank"
          ...
          <div className="relative rounded-2xl overflow-hidden border border-gold/40 shadow-2xl">
            <img
              ...
              alt="Destination Wedding Photographer Gujarat - KD Creation"
