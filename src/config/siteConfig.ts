...
export const SITE_CONFIG = {
  brand: {
    ...
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=KD+Creation+Luxury+Wedding+Films+Bapunagar+Ahmedabad+Gujarat",
    googleReviewUrl: "https://www.google.com/maps/search/?api=1&query=KD+Creation+Luxury+Wedding+Films+Bapunagar+Ahmedabad+Gujarat",
