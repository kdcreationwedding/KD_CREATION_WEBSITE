...
export const SITE_CONFIG = {
  brand: {
    ...
    foundedYear: 2018,
    location: "SG Highway, Prahlad Nagar, Ahmedabad, Gujarat 380015",
    address: "SG Highway, Prahlad Nagar, Ahmedabad, Gujarat 380015",
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=KD+Creation+Luxury+Wedding+Films+SG+Highway+Prahlad+Nagar+Ahmedabad+Gujarat",
    googleReviewUrl: "https://www.google.com/maps/search/?api=1&query=KD+Creation+Luxury+Wedding+Films+SG+Highway+Prahlad+Nagar+Ahmedabad+Gujarat",
